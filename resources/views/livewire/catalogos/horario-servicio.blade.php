<div wire:init='loadTable'>
    <div class="d-sm-flex align-items-center justify-content-between">
        ...
        <h1 class="ml-2">
            ...
            </a>Catalogo de horarios de servicio
        </h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-circle" aria-hidden="true"
                                        style="color:{{ $data->status_ctg_horario_servicio == 1 ? 'green' : 'red' }};"></i>
                                </td>
                                <td>

                                    <div class="btn-group">

                                        @if ($data->status_ctg_horario_servicio == 1)
