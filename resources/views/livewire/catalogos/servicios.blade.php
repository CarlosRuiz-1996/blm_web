                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <i class="fa fa-circle" aria-hidden="true"
                                        style="color:{{ $data->status_servicio == 1 ? 'green' : 'red' }};"></i>
                                </td>
                                <td>

                                    <div class="btn-group">

                                        @if ($data->status_servicio == 1)
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <x-input-validado label="Folio:" placeholder="Folio" wire-model="folio" type="text" />
                    </div>
                    <div class="col-md-12 mb-3">

                        <x-input-validado label="Descripción:" placeholder="Descripción" wire-model="descripcion" type="text" />
                    </div>
                    <div class="col-md-12 mb-3">

                        <x-input-validado label="Tipo:" placeholder="Tipo" wire-model="tipo" type="text" />
                    </div>
                    <div class="col-md-12 mb-3">

                        <x-input-validado label="Unidad:" placeholder="Unidad" wire-model="unidad" type="text" />
                    </div>
