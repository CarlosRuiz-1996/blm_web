<div>
    <div class="container-fluid pt-5"
        x-data="{ openRuta: null, openServicio: null, openCompra: null, openPuerta:null, openPuertaServ:null }">
        @if ($identificado)
                        ...
                        <div x-show="openRuta === {{ $index }}" x-collapse id="collapseRuta{{ $index }}">
                            <div class="card-body p-0">
                                ...
                                <div x-data="{ openServicio: null }">
                                    @foreach ($rutaServicio->rutaServicios->where('status_ruta_servicios', '!=',
                                    6)->where('puerta',0)->sortByDesc('updated_at') as $servicio)
                                    <div class="card m-0 text-xs">
                                        <div class="card-header p-0">
                                            <button class="btn btn-block text-center text-xs" :style="openServicio === {{ $servicio->id }} ?
                                                ...
                                                <p class="mb-0 text-danger">
                                                    {{ $servicio->tipo_servicio == 1 ? 'Entrega' :
                                                    ($servicio->tipo_servicio == 2 ? 'Recolección' : 'Otro') }}
                                                </p>
                                            </button>
                                        </div>
                                        <div x-show="openServicio === {{ $servicio->id }}" x-collapse
                                            id="collapseServicio{{ $servicio->id }}">
                                            <div class="card-body p-0">
                                                <div class="d-table table-info mt-0 pt-0" style="width:100%">
                                                    <div class="d-table-row text-sm" style="width:100%">
                                                        <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                            colspan="3">No. Servicio: <p class="text-bold">
                                                                {{ $servicio->id }}</p>
                                                        </div>
                                                        <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                            colspan="3">Papeleta: <p class="text-bold">
                                                                {{ $servicio->folio!=''?$servicio->folio:'N/A' }}</p>
                                                        </div>
                                                        <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                            colspan="1">Envases : <p class="text-bold">
                                                        ...
                                                        <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                            ...
                                                            <p>
                                                                ...
                                                                <button type="button"
                                                                    wire:click="transferir({{$servicio->id}})"
                                                                    data-toggle="modal" data-target="#ModalTransferir"
                                                                    class="btn btn-warning btn-sm text-xs mb-2 text-white">
                                                            ...
                                                            <p class="mb-0">
                                                                <button type="button"
                                                                    ...
                                                                    <i class="fas fa-play mr-1"></i>
                                                                    {{ $servicio->tipo_servicio == 1 ? 'Entregar' :
                                                                    ($servicio->tipo_servicio == 2 ? 'Recolectar' :
                                                                    'Otro') }}
                                                                </button>
                                                            </p>
                                                            <p class="mb-0">
                                                            ...
                                                            <p class="mb-0">
                                                                <button type="button"
                                                                    ...
                                                                    data-toggle="modal" data-target="#comisionModal">
                                                            ...
                                                            <p>
                                                                <span
                                                                    ...
                                                                    {{ $servicio->status_ruta_servicios == 3 ?
                                                                    'Terminado' : 'Reprogramado' }}
                                                                </span>
                                                            </p>
                                                            @endif
                                                        </div>
                                ...
                                <div x-data="{ openCompra: null }">
                                    ...
                                    <div class="card m-0">
                                        ...
                                        <div x-show="openCompra === {{ $ruta_compra->compra_efectivo_id }}" x-collapse
                                                        ...
                                                        <div class="d-block d-md-table-cell text-center pt-1 pb-0"
                                                            ...
                                                            : <p class="text-bold">
                                                                <span
                                                                    ...
                                                                    {{ $ruta_compra->compra->status_compra_efectivos ==
                                                                    2 ? 'Pendiente' : 'Finalizada' }}
                                                                </span>
                                                            </p>
                                                        </div>
                                                        <div class="d-block d-md-table-cell text-center pt-1 pb-0"
                                    ...
                                    <div x-data="{ openPuerta: null, openPuertaServ:null }">
                                        @foreach ($rutaServicio->rutaServicios->where('status_ruta_servicios', '!=',
                                        6)->where('puerta',1)->sortByDesc('updated_at') as $servicio)
                                        ...
                                        <div class="card m-0 text-xs">
                                            ...
                                            <div x-show="openPuerta === {{ $servicio->id }}" x-collapse
                                                id="collapsePuerta{{ $servicio->id }}">
                                                <div class="card-header p-0">
                                                    <button class="btn btn-block text-center text-xs" :style="openPuertaServ === {{ $servicio->id }} ?
                                                                            'background-color:#bee5eb' : 'bg-light'"
                                                ...
                                                <div class="card-body p-0"
                                                    x-show="openPuertaServ === {{ $servicio->id }}" x-collapse
                                                    id="collapsePuertaServ{{ $servicio->id }}">
                                                    <div class="d-table table-info mt-0 pt-0" style="width:100%">
                                                        <div class="d-table-row text-sm" style="width:100%">
                                                            <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                                colspan="3">No. Servicio: <p class="text-bold">
                                                            ...
                                                            <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                                colspan="3">Papeleta: <p class="text-bold">
                                                                    {{ $servicio->folio!=''?$servicio->folio:'N/A' }}
                                                                </p>
                                                            </div>
                                                            <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                                colspan="1">Envases : <p class="text-bold">
                                                            ...
                                                            <div class="d-block d-md-table-cell text-center pt-1 pb-0 mt-0 mb-0"
                                                                ...
                                                                @elseif($servicio->puertaHas->status_puerta_servicio ==
                                                                1)
                                                                <p class="mb-0">
                                                                    <button type="button"
                                                                        class="btn mb-2 btn-primary btn-sm text-xs"
                                                                        ...
                                                                        data-target="#ModalEntregarRecolectar">
                                                                        <i class="fas fa-play mr-1"></i>
                                                                        {{ $servicio->puertaHas->recolecta ==0 ?
                                                                        'Recolecta': 'Entrega' }}
                                                                    </button>
                                                                </p>
                                                                @else
                        ...
                        <div class="row" wire:init='loadServicios'>
                            ...
                            <div class="col-md-2 mb-3" style="margin-top: 32px">
                                ...
                                <div class="input-group @error('inputs.{{ $index }}.photo') is-invalid @enderror">
                                    ...
                                    <input type="file" id="inputs.{{ $index }}.photo"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span
                                            ...
                                            {{ $detalle->status_detalles_compra_efectivos == 2 ? 'Terminado' :
                                            'Rechazado' }}
                                        </span>
                                        @endif
                                    </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" wire:init='loadServicios'>
                            ...
                            <div class="col-md-8 mb-4">
                                <x-input-validado label="Dirección:" :readonly="true" wire-model="direccion_comision"
                                    type="text" />
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('monto_comision') is-invalid @enderror"
                            ...
                            <div class="col-md-3 d-flex justify-content-center align-items-center">
                                ...
                                <img src="{{ $evidencia_comision->temporaryUrl() }}" alt="Foto Tomada" class="img-fluid"
                                    style="max-width: 100px; height: auto;">
                                @endif
                            </div>
                            @else
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary" data-dismiss="modal"
                            wire:click='cleanComision'>Cerrar</button>
        ...
        <!--transferir-->
        <div class="modal fade" id="ModalTransferir" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2"
            tabindex="-1" wire:ignore.self>
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-info">
                        <h5 class="modal-title" id="exampleModalLabel">Transferir Servicio</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                            wire:click='limpiarTranf'>
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row" wire:init='loadServicios'>
                            ...
                            <div class="col-md-3 mb-4">
                                <x-input-validado label="Cliente:" :readonly="true" wire-model="cliente_transf"
                                    type="text" />
                            </div>
                            <div class="col-md-3 mb-4">
                                <x-input-validado label="Servicio:" :readonly="true"
                                    wire-model="transferir_servicio_tipo" type="text" />
                            </div>
                            <div class="col-md-3 mb-4">
                                <x-input-validado label="Papeleta:" :readonly="true" wire-model="papeleta_transf"
                                    type="text" />
                            </div>
                            <div class="col-md-3 mb-4">
                                <x-input-validado label="Monto:" :readonly="true" wire-model="monto_transf"
                                    type="text" />
                            </div>
                            <div class="col-md-3 mb-4">
                                <x-input-validado label="Tipo:" :readonly="true" wire-model="tipo_transf" type="text" />
                            </div>
                            <div class="col-md-8 mb-4">
                                <x-input-validado label="Dirección:" :readonly="true" wire-model="direccion_transf"
                                    type="text" />
                            </div>


                            <div class="col-md-3 mb-3">
                                <x-select-validadolive label="Ruta:" placeholder="" wire-model="ruta_id" required>
                                    ...
                                    @endforeach
                                    @else
                                    <option value="">Sin rutas disponibles</option>
                                    @endif
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-secondary" data-dismiss="modal"
                            wire:click='limpiarTranf'>Cerrar</button>
                        <button class="btn btn-info" wire:click='saveTransfer' wire:loading.remove>Guardar</button>
