    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <a href="{{ route('clientesactivos.CotizacionesNuevas') }}" class="btn btn-info btn-block ">Crear cliente</a>
            <hr class="m-4">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    class="form-control"
                    id="nombrecliente"
                    placeholder="Ingrese nombre de cliente a buscar"
                ...
                @if(count($sugerencias) > 0)
                    <div class="list-group mt-2">
                        @foreach($sugerencias as $sugerencia)
                            <div class="list-group-item" wire:click="seleccionarCliente('{{ $sugerencia->id }}', '{{ $sugerencia->name }} {{ $sugerencia->paterno }} {{ $sugerencia->materno }}')">
            ...
            <a class="btn btn-info btn-block" href="{{ route('clientesactivos.cotizardenuevo', $idseleccionado) }}">Crear</a>
        </div>
      </div>
    </div>
  </div>
