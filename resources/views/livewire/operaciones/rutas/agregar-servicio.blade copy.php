                ...
                <tbody>
                    ...
                    @foreach ($servicios as $servicio)
                        <tr x-data="{
                            ...
                            <td>
                                <input type="checkbox" 
                                {{-- wire-model="servicios.{{ $servicio['id'] }}.select" --}} {{-- wire:model.live='selectServicios.{{$servicio['id'] }}' --}} {{-- x-model="checkServicio" wire:click="resetError('{{$servicio['id'] }}')" --}}
                            ...
                            <td>{{ $servicio['razon_social'] }}</td>
                            <td>{{ $servicio['direccion'] }}
                            </td>
                            <td>
                                <div class="d-flex flex-column">
                                    <div class="form-check mt-2">
                                        ...
                                        <input class="form-check-input" type="checkbox"
                                            x-bind:value="checkServicio ? tipo : '1'" x-bind:disabled="!checkServicio"
                                            x-model="checkbox1" {{-- wire:model='selectServiciosRecolecta.{{$servicio['id'] }}' --}}
                                            wire-model="servicios.{{ $servicio['id'] }}.recolecta"
                                    ...
                                    <div class="form-check mt-4">
                                        <input class="form-check-input" type="checkbox"
                                            x-bind:value="checkServicio ? tipo : '2'" x-bind:disabled="!checkServicio"
                                            x-model="checkbox2"
                                            @change="if (!checkbox2) { monto2 = ''; folio2 = ''; contenedor2='' ; }"
                                            {{-- wire-model='selectServiciosEntrega.{{$servicio['id'] }}' --}} wire-model="servicios.{{ $servicio['id'] }}.entrega"
                                            wire:click="resetError('{{ $servicio['id'] }}')" />
                                        <label class="form-check-label"
                            ...
                            <td>
                                <div class="d-flex flex-column">
                                    <x-input-validado
                                        ...
                                        x-model="monto" placeholder="Monto" {{-- wire-model='montoArrayRecolecta.{{$servicio['id'] }}'  --}}
                                        wire-model="servicios.{{ $servicio['id'] }}.recolecta_monto" type="number" />
                                    <x-input-validado
                                        x-bind:value="checkServicio ? monto2 : '' || checkbox2 ? monto2 : ''"
                                        style="margin-top: -25%" x-bind:disabled="!checkServicio || !checkbox2"
                                        x-model="monto2" placeholder="Monto" {{-- wire-model='montoArray.{{$servicio['id'] }}'  --}}
                                        wire-model="servicios.{{ $servicio['id'] }}.recolecta_entrega"
                                        type="number" />
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column">
                                    <x-input-validado
                                        ...
                                        x-model="folio" placeholder="Papeleta" {{-- wire-model='folioArrayRecolecta.{{$servicio['id'] }}' --}}
                                        wire-model="servicios.{{ $servicio['id'] }}.recolecta_folio" type="text" />
                                    <x-input-validado
                                        x-bind:value="checkServicio ? folio2 : '' || checkbox2 ? folio2 : ''"
                                        style="margin-top: -22%" x-bind:disabled="!checkServicio || !checkbox2"
                                        x-model="folio2" placeholder="Papeleta" {{-- wire-model='folioArray.{{$servicio['id'] }}' --}}
                                        wire-model="servicios.{{ $servicio['id'] }}.entrega_folio" type="text" />
                                </div>
                            </td>
                            <td>
                                <div class="d-flex flex-column">
                                    <x-input-validado
                                        ...
                                        style="margin-top: -17%" x-bind:disabled="!checkServicio || !checkbox1"
                                        x-model="contenedor" placeholder="Envases" {{-- wire-model='envaseArrayRecolecta.{{$servicio['id'] }}' --}}
                                        wire-model="servicios.{{ $servicio['id'] }}.recolecta_envase" type="number" />
                                    <x-input-validado
                                        x-bind:value="checkServicio ? contenedor2 : '' || checkbox2 ? contenedor2 : ''"
                                        style="margin-top: -21%" x-bind:disabled="!checkServicio || !checkbox2"
                                        x-model="contenedor2" placeholder="Envases" {{-- wire-model='envaseArray.{{$servicio['id'] }}' --}}
                                        wire-model="servicios.{{ $servicio['id'] }}.entrega_envase" type="number" />
                                </div>
                            </td>
                        ...
                        <tbody>
                            ...
                            @foreach ($servicios as $servicio)
                                <tr x-data="{
                                    ...
                                    <td>
                                        <input type="checkbox" wire-model="servicios.{{ $servicio['id'] }}.select"
                                            {{-- wire:model.live='selectServicios.{{$servicio['id'] }}' --}} x-model="checkServicio"
                                            wire:click="resetError('{{ $servicio['id'] }}')"
                                            @change="updateCheckboxes" />
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="form-check mt-4">
                                                <input class="form-check-input" type="checkbox"
                                                    ...
                                                    wire-model="servicios.{{ $servicio['id'] }}.entrega"
                                                    wire:click="resetError('{{ $servicio['id'] }}')" />
                                                <label class="form-check-label"
                                                    for="selectServiciosEntrega.{{ $servicio['id'] }}">Entrega</label>
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <x-input-validado
                                                x-bind:value="checkServicio ? monto : '' || checkbox1 ? monto : ''"
                                                style="margin-top: -20%"
                                                x-bind:disabled="!checkServicio || !checkbox1" x-model="monto"
                                                placeholder="Monto" {{-- wire-model='montoArrayRecolecta.{{$servicio['id'] }}'  --}}
                                                wire-model="servicios.{{ $servicio['id'] }}.recolecta_monto"
                                                type="number" />
                                            <x-input-validado
                                                x-bind:value="checkServicio ? monto2 : '' || checkbox2 ? monto2 : ''"
                                                style="margin-top: -25%"
                                                x-bind:disabled="!checkServicio || !checkbox2" x-model="monto2"
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <x-input-validado
                                                x-bind:value="checkServicio ? folio : '' || checkbox1 ? folio : ''"
                                                style="margin-top: -19%"
                                                x-bind:disabled="!checkServicio || !checkbox1" x-model="folio"
                                                placeholder="Papeleta" {{-- wire-model='folioArrayRecolecta.{{$servicio['id'] }}' --}}
                                                wire-model="servicios.{{ $servicio['id'] }}.recolecta_folio"
                                                type="text" />
                                            <x-input-validado
                                                x-bind:value="checkServicio ? folio2 : '' || checkbox2 ? folio2 : ''"
                                                style="margin-top: -22%"
                                                ...
                                                wire-model="servicios.{{ $servicio['id'] }}.entrega_folio"
                                                type="text" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <x-input-validado
                                                ...
                                                placeholder="Envases" {{-- wire-model='envaseArrayRecolecta.{{$servicio['id'] }}' --}}
                                                wire-model="servicios.{{ $servicio['id'] }}.recolecta_envase"
                                                type="number" />
                                            <x-input-validado
                                                x-bind:value="checkServicio ? contenedor2 : '' || checkbox2 ? contenedor2 : ''"
                                                style="margin-top: -21%"
                                                ...
                                                wire-model="servicios.{{ $servicio['id'] }}.entrega_envase"
                                                type="number" />
                                        </div>
                                    </td>
