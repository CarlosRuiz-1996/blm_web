<div>
                            ...
                            <tbody class="text-center">
                                @foreach ($sucursales as $sucursal)
                                    <tr>
                                        ...
                                        <td>Calle
                                            {{ $sucursal->direccion . ' ' . $sucursal->cp->cp . ' ' . $sucursal->cp->estado->name . ' ' }}
                                        </td>
        ...
        <div class="col-md-12 mb-3">
            <div class="row">
                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Evaluación:" placeholder=""
                        wire-model="form.fecha_evaluacion" type="text" />
                </div>

                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Inicio de servicio:" placeholder=""
                        wire-model="form.fecha_inicio_servicio" type="text" />
                </div>
                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Ejecutivo de cuenta:" placeholder=""
                        wire-model="form.ejecutivo" required type="text" />
                </div>

                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Sucursal:" placeholder="" wire-model="form.sucursal_name"
                        required type="email" />
                </div>

                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Domicilio:" placeholder="" wire-model="form.direccion"
                        type="text" />
                </div>

                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Correo:" placeholder="" wire-model="form.correo"
                        type="text" />
                </div>
                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Telefono:" placeholder="" wire-model="form.phone"
                        type="text" />
                </div>
                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Contacto:" placeholder="" wire-model="form.contacto"
                        type="text" />
                </div>
                <div class="col-md-4 mb-3">
                    <x-input-validado :readonly="true" label="Cargo:" placeholder="" wire-model="form.cargo"
                        type="text" />
                </div>
                <div class="col-md-12 mb-3">
                    <x-input-validado :readonly="true" label="Direccion:" placeholder="" wire-model="form.direccion"
                        type="text" />
                </div>
                <div class="col-md-12 mb-3">
                    @if ($form->servicios)
    ...
    {{-- reporte generar --}}
    <div class="modal fade" id="modalRpt" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h3 class="modal-title" id="exampleModalLongTitle">Reporte de factibilidad</h3>
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link {{ $active_form }}" wire:click='CambiarTab' id="form-tab"
                                data-toggle="pill" href="#form" role="tab" aria-controls="form"
                        ...
                        <div class="tab-pane fade {{ $active_form }}" id="form" role="tabpanel"
                            ...
                            <div class="row g-3">
                                <div class="form-group ml-3 col-md-5">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1"
                                            value="0" wire:model='form.tiposervicio'>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1"
                                            value="1" wire:model='form.tiposervicio'>
                                        <label class="form-check-label">
                                            E.V.
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="2"
                                            name="pregunta1" wire:model='form.tiposervicio'>
                                        <label class="form-check-label">
                                            E. MON. MET.
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="pregunta1otro"
                                            value="3" wire:model='form.tiposervicio'>
                                        <label class="form-check-label">
                                            OTROS
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-3 col-md-5">
                                    ...
                                    <input class="form-control ml-5 col-sm-8" value="1"
                                        placeholder="LUN A VIE 18:0 A 20:00" wire:model='form.horarioservicio'
                                        readonly>
                                    <x-input-error for="form.horarioservicio" />
                                    <label class="control-label">Numero de personas que se requieren para el
                                        servicio:</label>
                                ...
                                <div class="form-group ml-5 col-md-6">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4"
                                            value="0" wire:model='form.tipoconstruccion'>
                                        <label class="form-check-label">
                                            concreto
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="1"
                                            name="pregunta4" wire:model='form.tipoconstruccion'>
                                        <label class="form-check-label">
                                            Madera
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="pregunta4otro"
                                            value="4" wire:model='form.tipoconstruccion'>
                                        <label class="form-check-label">
                                            Otros
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-3 col-md-5">
                                    <label class="control-label ">5. Nivel de protección con el que cuenta el
                                        ligar:</label>
                                    <div class="form-check">
                                    ...
                                    <label class="control-label ml-3">El perímetro de la instalación se encuentra
                                        bardeado:
                                    </label>
                                    <div class="form-check ml-3">
                                        <input class="form-check-input" type="radio" id="pregunta5-5"
                                            value="0" wire:model='form.perimetro'>
                                        <label class="form-check-label">
                                            No
                                        </label>
                                    </div>
                                    <div class="form-check ml-3">
                                        <input class="form-check-input" type="radio" id="pregunta5-5"
                                            value="1" wire:model='form.perimetro'>
                                        <label class="form-check-label">
                                            Si
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-5 col-md-5">
                                    <label class="control-label">6. Indique el número de accesos para llegar al lugar
                                        de la
                                        recolección
                                ...
                                <div class="form-group ml-3 col-md-4">
                                    <label class="control-label">7. Cuenta con control de accesos y registro de
                                        visitantes en
                                        bitácora:</label>
                                    <div class="form-check">
                                ...
                                <div class="form-group  col-md-7">
                                    <div class="row g-3">
                                        <div class="form-group  col-md-7">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="pregunta8"
                                                    wire:model='form.guardiaseg' id="pregunta8otros" value="2"
                                                    required>
                                                <label class="form-check-label">
                                                    Otros
                                                </label>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" id="pregunta8cual-label">(Indique
                                                    cuales)</label>
                                                <input class="form-control" type="text"
                                                    wire:model='form.otros_guardiaseg' id="pregunta8cual"
                                                    style="text-transform:uppercase;">
                                            </div>
                                        ...
                                        <div class="form-group col-md-5 mt-4">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" id="corporación">Nombre de la
                                                    corporación</label>
                                                <div class="">
                                                    <input class="form-control" type="text"
                                                        wire:model='form.corporacion_armados'
                                                        id="pregunta85nombrecorporacion"
                                                        style="text-transform:uppercase;">
                                                </div>
                                            </div>
                                ...
                                <div class="form-group ml-3 col-md-6">
                                    <label class="control-label">9. Las instalaciones del cliente cuentan con algún
                                        tipo de
                                        alarma</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="0"
                                            wire:model='form.alarma'>
                                        <label class="form-check-label">
                                ...
                                <div class="form-group ml-3 col-md-5">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <div class="">
                                            <input class="form-control" type="text"
                                                wire:model='form.otros_tiposenial' name="pregunta10-5"
                                                id="pregunta10-5" style="text-transform:uppercase;" value="">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group ml-3 col-md-5">
                                    <label class="control-label ">11. Tiempo de respuesta que tiene para atender el
                                        llamado de
                                        alarma:</label>
                                    <div class="">
                                ...
                                {{-- 12 --}}
                                <div class="form-group ml-5 col-md-5">
                                    <label class="control-label">12. En caso de falla de energía eléctrica cuenta
                                        con:</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="0"
                                ...
                                <div class="form-group ml-3 col-md-5">
                                    <label class="control-label">13. Cuenta con cámaras de seguridad el
                                        establecimiento:</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="0"
                                            wire:model='form.camaras'>
                                        <label class="form-check-label">
                                ...
                                <div class="form-group ml-5 col-md-5">
                                    <label class="control-label">14. Cuenta con cofre de seguridad operado por su
                                        personal o en
                                        renta
                                        con PRO-BLM.</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="0"
                                            wire:model='form.cofre'>
                                        <label class="form-check-label">
                                            Propio
                                        </label>
                                    </div>
                                ...
                                <div class="form-group ml-3 col-md-11">
                                    <label class="control-label ">15. Mencione la siniestralidad (asaltos o intentos de
                                        asalto)
                                        que
                                        ha
                                    ...
                                    <div class="">
                                        <input class="form-control" type="text"
                                            wire:model='form.descripcion_asalto' style="text-transform:uppercase;">
                                    </div>
                                ...
                                <div class="form-group ml-3 col-md-11">
                                    <label class="control-label col-sm-8">16. Indique el nombre del ejecutivo de ventas
                                        que
                                        realizó
                                        la
                                ...
                                <div class="form-group ml-3 col-md-5">
                                    <label class="control-label ">17. Evalúe la zona donde se encuentra ubicada la
                                        recolección
                                        de
                                ...
                                <div class="form-group ml-5 col-md-6">
                                    <label class="control-label">18. Indique si es conveniente para SERVICIOS
                                        INTEGRADOS PRO-BLM
                                        DE
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>FOTO FACHADA</td>
                                                        <td>
                                                            <input type="file" id="foto_fachada"
                                                                style="display: none;" wire:model='foto_fachada'>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="file" id="foto_accesos"
                                                                style="display: none;" wire:model='foto_accesos'>
                                                            <button type="button" class="btn btn-primary"
                                                                wire:click='subirImagen'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="file" id="foto_seguridad"
                                                                wire:model='foto_seguridad' style="display: none;">
                                                            <button type="button" class="btn btn-primary"
                                                                wire:click='subirImagen'
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn-flat ml-3 btn-danger btn-lg" class="close" data-dismiss="modal"
                        aria-label="Close">Cancelar </button>

                    <button class="btn-flat ml-3 btn-lg btn-primary"
        ...
        <script>
            document.addEventListener('livewire:initialized', () => {
                ...
                @this.on('confirm', () => {
                    ...
                    Swal.fire({
                        title: '¿Estas seguro?',
                        text: "El reporte de factibilidad se guardara",
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            @this.dispatch('save-factibilidad');
                        }
                    })
                })
