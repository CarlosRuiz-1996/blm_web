<div>
                    ...
                    <tbody>
                        ...
                        @foreach($ruta->rutaServicios->where('status_ruta_servicios','>=',3)->where('puerta',0)->where('status_ruta_servicios','<=',5) as $servicio) <tr x-show="servicio">
                            ...
                            @if(!$puertas->isEmpty())
                                ...
                                @foreach($ruta->rutaServicios->where('status_ruta_servicios','>=',3)->where('puerta',1)->where('status_ruta_servicios','<=',5) as $servicio) <tr x-show="puerta">
                                    <td>
                                        {{ $servicio->id }}
                                    </td>
                                    <td>{{ $servicio->servicio->cliente->razon_social }}</td>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-info" data-toggle="modal"
                                            wire:click='detallesPuerta({{ $servicio }})'
                                            data-target="#ModalDetallePuerta">Detalles</button>
                                    ...
                                    <td>
                                        @if ($servicio->status_ruta_servicios != 5)
                                        <button class="btn btn-info" wire:click='endPuerta({{ $servicio }})'>Finalizar
                                            servicio</button>
    ...
    {{-- detalles de puerta --}}
    <div class="modal fade" id="ModalDetallePuerta" wire:ignore.self tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Detalles del servicio puerta en puerta
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#evidenciaModal"
                                            wire:click='evidenciaPuerta({{ $index }},1)'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                fill="currentColor" class="bi bi-image" viewBox="0 0 16 16">
                                                <path
                                                    d="M13.002 1H2.998C2.447 1 2 1.447 2 2.002v11.996C2 14.553 2.447 15 2.998 15h11.004c.551 0 .998-.447.998-.998V2.002A1.002 1.002 0 0 0 13.002 1zM3 2h10a1 1 0 0 1 1 1v8.586l-3.293-3.293a1 1 0 0 0-1.414 0L7 10.586 5.707 9.293a1 1 0 0 0-1.414 0L3 10.586V3a1 1 0 0 1 1-1z" />
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#evidenciaModal"
                                            wire:click='evidenciaPuerta({{ $index }},2)'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                fill="currentColor" class="bi bi-image" viewBox="0 0 16 16">
                                                <path
                                                    d="M13.002 1H2.998C2.447 1 2 1.447 2 2.002v11.996C2 14.553 2.447 15 2.998 15h11.004c.551 0 .998-.447.998-.998V2.002A1.002 1.002 0 0 0 13.002 1zM3 2h10a1 1 0 0 1 1 1v8.586l-3.293-3.293a1 1 0 0 0-1.414 0L7 10.586 5.707 9.293a1 1 0 0 0-1.414 0L3 10.586V3a1 1 0 0 1 1-1z" />
