...
<body>
    <div class="container">
        ...
        <p class="text-justify mt-5 mb-5" style="font-size: 12px">
            ...
            <br>
            <br>
            Después de haber revisado los datos en la Carta de Ley Antilavado, validado los documentos para la
            integración del expediente único y realizar
            la verificación del cliente y sus relacionados en el Web Service de Q&Q, No se otorga el VoBo para continuar
            con el proceso de contratación del
            cliente: ({{ $razonSocial }}), debido al siguiente motivo:
        </p>
        ...
        <table class="table table-bordered mb-5" style="font-size: 12px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><b>{{ $resultado->status_cumplimiento_rechazo == 1 ? 'X' : '' }}</b></td>
                </tr>
                @endforeach
            </tbody>
        </table>
