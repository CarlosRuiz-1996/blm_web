...
<body>
    <div class="container">
        <div class="row">
            ...
            <br>
            <br>
            Se otorga el VoBo para continuar con el proceso de contratacion del cliente: PRUEBA MAPA
        </p>
        ...
        <p class="text-justify mt-2" style="font-size: 12px">
            Sin mas por el momento, atento a cualquier duda o aclaracion. rz:PRUEBA MAPA 
            <br>
            <br>
