...
return new class extends Migration
{
    ...
    {
        Schema::create('cumplimiento_doc_validacion', function (Blueprint $table) {
            $table->id();
            //cumplimiento
            ...
            $table->string('nota');
            $table->integer('status_validacion_doc_cumplimiento')->default(1);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('cumplimiento_doc_validacion');
    }
};
